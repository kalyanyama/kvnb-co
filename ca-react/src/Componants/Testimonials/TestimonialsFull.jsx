...
export default function TestimonialsFull() {
  return (
    <div className="container-fluid" id="testimonials-full">
      <div className="container p-5" data-aos="zoom-out">
        <div className="container my-5">
          ...
          <div className="row ">
            ...
            <h5 className=" text-success">Rohan Patel</h5>
            ...
            <div className="col-md-3 mx-auto my-3 col-lg-3 rounded-lg p-3 bg-light shadow">
            <h5 className=" text-success">Ethan Wilson</h5>
            <div className="text-center">
                <h6 className="font-weight-bold my-0">
                  <i className="bi bi-star-fill text-warning"></i>
                  <i className="bi bi-star-fill text-warning"></i>
          ...
          <div className="row ">
            <div className="col-md-3 mx-auto my-3 col-lg-3 rounded-lg p-3 bg-light shadow">
            <h5 className=" text-success">Vinay Anoop</h5>
            <div className="text-center">
                <h6 className="font-weight-bold my-0">
                  <i className="bi bi-star-fill text-warning"></i>
                  <i className="bi bi-star-fill text-warning"></i>
