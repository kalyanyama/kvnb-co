...
export default function Header() {
  ...
  const handleScroolNav = () => {
    window.scrollY > 0
      ? (setActive(true),
        setBgChangeHeader("next-header"),
        setBgChangeNav("bg-header"))
      : (setActive(false),
        setBgChangeHeader("bg-header"),
        setBgChangeNav("next-header"));
  };
    ...
    <div className="container">
      <header className="d-flex flex-column  fixed-top" id="header">
        <nav
          className={
            pathname === "/"
              ? `navbar navbar-expand-lg ${bgChangeHeader} border-bottom navbar-light p-3`
              : "navbar navbar-expand-lg bg-light border-bottom navbar-light p-3"
          }
        >
          <div className="container">
            <Link className="navbar-brand" to="/">
              <img src="/imgs/logo.png" width="60px" className="mx-3" />
              {domainName.label}
            </Link>
            <button
              ...
              <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item dropdown hover">
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <Link className="dropdown-item" to="/audit-assurance">
                        Audit & Assurance
                      </Link>
                    </li>
                    <li>
                      <Link className="dropdown-item" to="/direct-indirect">
                        Direct & Indirect taxes
                      </Link>
                    </li>
                    <li>
                      <Link className="dropdown-item" to="/nri">
                        NRI compliances
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link className="dropdown-item" to="/business-startup">
                        Business Establishment
                      </Link>
                    </li>
                    <li>
                      <Link className="dropdown-item" to="/book-keeping">
                        Book keeping
                      </Link>
                    </li>
                    <li>
        ...
        {active && pathname === "/" && (
          <div
            className={`container-fluid ${bgChangeNav} border-bottom below-nav`}
          >
            <div className="container">
