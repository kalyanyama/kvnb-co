...
export default function News() {
  ...
  useEffect(() => {
   const fetching =()=>{
    fetch(
       "https://gnews.io/api/v4/search?q=tax&lang=en&country=in&max=30&apikey=0592711ca96bfa23d52fbd0cf0e4128b"
     )
       .then((res) => res.json())
  ...
  const mapping = newsLists?.map((newss, n)=>{
   return(
    <>
    <div className="col-md-6 col-lg-6 border border-2 p-5 " key={n}>
