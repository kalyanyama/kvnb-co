          ...
          <div className="col-md-4 mx-auto my-3 col-lg-4 card rounded-lg p-3 bg-light shadow ">
            ...
            <div className=" card-back">
              ...
              <p>
                Mobile :
                <span>
                  <a href="tel:9133417297">+91 9133417297</a>
                </span>
              </p>
              <p>
                Email :{" "}
                <span>
                  <a href="mailto:ca.vishwamber@gmail.com2">
          ...
          <div className="col-md-4 mx-auto my-3 card col-lg-4 rounded-lg p-3 bg-light shadow ">
            ...
            <div className=" card-back">
              ...
              <p>
                Mobile :{" "}
                <span>
                  <a href="tel:9133498272">+91 9133498272</a>
                </span>
              </p>
              <p>
                Email :{" "}
                <span>
                  <a href="mailto:cabharathnalla.ncbr@gmail.com">
